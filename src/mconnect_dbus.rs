...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgMconnectDeviceBattery for blocking::Proxy<'a, C> {

    fn level(&self) -> Result<u32, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device.Battery", "Level")
    }

    fn charging(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device.Battery", "Charging")
    }

    fn set_level(&self, value: u32) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device.Battery", "Level", value)
    }

    fn set_charging(&self, value: bool) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device.Battery", "Charging", value)
    }
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgMconnectDevicePing for blocking::Proxy<'a, C> {
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgMconnectDeviceShare for blocking::Proxy<'a, C> {
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgMconnectDeviceTelephony for blocking::Proxy<'a, C> {

    fn send_sms(&self, number: &str, message: &str) -> Result<(), dbus::Error> {
        self.method_call("org.mconnect.Device.Telephony", "SendSms", (number, message, ))
    }
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgMconnectDevice for blocking::Proxy<'a, C> {

    fn id(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "Id")
    }

    fn name(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "Name")
    }

    fn device_type(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "DeviceType")
    }

    fn protocol_version(&self) -> Result<u32, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "ProtocolVersion")
    }

    fn address(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "Address")
    }

    fn is_paired(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "IsPaired")
    }

    fn allowed(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "Allowed")
    }

    fn is_active(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "IsActive")
    }

    fn is_connected(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "IsConnected")
    }

    fn incoming_capabilities(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "IncomingCapabilities")
    }

    fn outgoing_capabilities(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "OutgoingCapabilities")
    }

    fn certificate(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "Certificate")
    }

    fn certificate_fingerprint(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.mconnect.Device", "CertificateFingerprint")
    }

    fn set_id(&self, value: String) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "Id", value)
    }

    fn set_name(&self, value: String) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "Name", value)
    }

    fn set_device_type(&self, value: String) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "DeviceType", value)
    }

    fn set_protocol_version(&self, value: u32) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "ProtocolVersion", value)
    }

    fn set_address(&self, value: String) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "Address", value)
    }

    fn set_is_paired(&self, value: bool) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "IsPaired", value)
    }

    fn set_allowed(&self, value: bool) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "Allowed", value)
    }

    fn set_is_active(&self, value: bool) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "IsActive", value)
    }

    fn set_is_connected(&self, value: bool) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "IsConnected", value)
    }

    fn set_incoming_capabilities(&self, value: Vec<String>) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "IncomingCapabilities", value)
    }

    fn set_outgoing_capabilities(&self, value: Vec<String>) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "OutgoingCapabilities", value)
    }

    fn set_certificate(&self, value: String) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "Certificate", value)
    }

    fn set_certificate_fingerprint(&self, value: String) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(&self, "org.mconnect.Device", "CertificateFingerprint", value)
    }
}
